...
const HomeData = () => {
  return (
    <div className="home__data">
        <h1 className="home__title">Sanjog Pawar
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <p className="home__description">
         I'm Java Full Stack Developer builds both server-side (Java, Spring Boot) & client-side (React.js, HTML, CSS) 
         components, manages databases, & integrates APIs to deliver full-stack applications. 
        </p>
